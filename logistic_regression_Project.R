...
library("mice")
NH11_clean <- NH11[c("everwrk", "age_p", "r_maritl")]
str(NH11_clean)
summary(NH11_clean)
set.seed(88)
# Do imputation
NH11_imputed <- complete(mice(NH11_clean))
summary(NH11_imputed)

# copy into original data frame
...
table(NH11_clean$everwrk)
27894/(27894+5058)
# 1 Yes 27894, 2 No 5058, Most have worked, 27894/(27894+5058) = 84.7%

# Split into Training and Testing Set
split = sample.split(NH11_clean$everwrk, SplitRatio = 0.75)  # between 50% and 80% of the data
NH11_clean_train <- subset(NH11_clean, split == TRUE)
NH11_clean_test <- subset(NH11_clean, split == FALSE)
